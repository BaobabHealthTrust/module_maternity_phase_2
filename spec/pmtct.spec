P.1. Observations [program: MATERNITY PROGRAM, scope: TODAY, includecss: pmtctAlert, concept: HIV Status, label: Ante Natal PMTCT, pos: 10, parent: 4]
...
Q.1.1.3. On ARVs [helpText: On ART?, tt_BeforeUnLoad: checkARTStart("1.1.3"), concept: ON ARVS, field_type: text, pos: 2, condition: __$("1.1.1").value.trim().toUpperCase() == "REACTIVE"]
O.1.1.3.1. No
O.1.1.3.2. Yes
