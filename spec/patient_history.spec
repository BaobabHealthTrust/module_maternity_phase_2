...
Q.1.1.5.  Number Of Caesarean Sections [concept: Caesarean Section, tt_OnUnLoad: check("1.1.5"), pos: 4, field_type: number, condition: __$("1.1.1").value > 1, tt_pageStyleClass: NumbersOnly]

Q.1.1.6.  Number Of breech Deliveries [concept: Breech delivery, tt_OnUnLoad: check("1.1.6"), pos: 5, field_type: number,  condition: __$("1.1.1").value > 1, tt_pageStyleClass: NumbersOnly]

Q.1.1.7.  Number Of Vacuum Extraction Deliveries [concept: Vacuum extraction delivery, tt_OnUnLoad: check("1.1.7"),  condition: __$("1.1.1").value > 1, pos: 6, field_type: number, tt_pageStyleClass: NumbersOnly]

Q.1.1.8.  Number Of Spontaneous Vaginal Deliveries [concept: Spontaneous vaginal delivery, tt_OnUnLoad: check("1.1.8"), pos: 7,  condition: __$("1.1.1").value > 1, field_type: number, tt_pageStyleClass: NumbersOnly]
