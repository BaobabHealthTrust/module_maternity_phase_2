...
Q.1.7. Complications [optional: true, condition: !($("1.6").value.length > 0) && ($("1.5").value.toLowerCase().trim() != "none"), ajaxURL: /encounters/list_complications?search_string=, helpText: Select next mother complication, pos: 8, name: concept[Complications][]]
