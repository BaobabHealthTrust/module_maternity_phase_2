...
Q.1.2. Weight (grams) [concept: Weight, pos: 1, field_type: number, absoluteMin: 100, min: 500, max: 5000, condition: try{wards_map[$("1.1").value].toLowerCase().trim() == "kangaroo"}catch(ex){false}, absoluteMax: 10000, tt_pageStyleClass: NumbersOnlyWithDecimal]
