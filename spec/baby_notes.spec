P.1. Observations [program: UNDER 5 PROGRAM, scope: TODAY, label: Notes, pos: 14, parent: 2, concept: Clinician Notes]
...
Q.1.1.2. Notes [concept: CLINICIAN NOTES, field_type: textarea, condition: id_string.match(__$("1.1.1").value), allowFreeText: true, pos: 1, optional: true]
